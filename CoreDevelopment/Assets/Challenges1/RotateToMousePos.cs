...
//		transform.eulerAngles = new Vector3 (desiredAngle,90f,-90f);
		...
		//Quaternion newLookDir = Quaternion.LookRotation (mousePos - transform.position, Vector3.up, );
		//Quaternion.RotateTowards(transform.rotation, newLookDir, rotationSpeed);
	}
}
